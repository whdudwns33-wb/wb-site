...
## 원문끼리 충돌 — 사용자 결정 대기 (양쪽 모두 보존해 둠)

1. hr-playbook 내부 시급표 2벌: 채용부(1~3년차 25,000~32,000원) vs 리텐션부(신입 18,000/3년차 22,000/5년+ 25,000원)
2. 채용 채널 1순위: 채용부 "훈장마을" vs 리텐션부 대체채용 "사람인"
3. 맘카페 계정 체계: agent-marketing(순광맘·광수방·맘스팡) vs agent-editor(계정 A/B/C)
