...
`docs/국어내신-학습웹앱-기획서-v1.md` (v1.0) — 족보닷컴 자료 기반 중등 국어 내신 앱.
코드는 아직 없다. **착수 전 선결 과제 두 가지**(기획서 §10-1·§10-2): 족보닷컴 약관상
앱 탑재 허용 여부 서면 확인, 수록 문학 원작의 전송권 경로. 둘은 상대가 다르므로 따로 푼다.
자료·리서치 분석과 5개 관점 검토 결과가 기획서에 반영돼 있다.
