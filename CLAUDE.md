...
- **어휘브레인 `/hanja/`**: 한글 어휘가 약한 학생이 **추천 교재의 단원 시험 → 낱말 학습 → 재확인**을 하는 앱. 영어 없음, 한자는 어휘 이해를 돕는 선택 기능이다.
